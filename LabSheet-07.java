...
/* displayed:  Cannot override final method display() in class Student
  ...
  * The code will not compile because the display() method is declared as final. A final method cannot be overridden by a subclass, and since the Student class is final, it cannot be subclassed. Therefore, 
  the display() method cannot be overridden.*/



 /*Exercise 02:
Develop a code base for the following scenario. Shape class contains an abstract method called “calculateArea” and non-abstract method called “display”. Try to pass required values at the instantiation. 
